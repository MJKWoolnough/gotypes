...
// Lookup resolves qualified object names to a types.Object.
//
// The imports map is as generated by the Imports function.
//
// The typeName should be in the form of PATH_NAME.OBJECT_NAME, for example:
//
// io.LimitedReader
